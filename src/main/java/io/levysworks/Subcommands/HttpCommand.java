...
public class HttpCommand implements Callable<Integer> {
    ...
    BodyContentExclusive bodyContentExclusive;
    ...
    public Integer call() {
        ...
        if (!(method.equals(HTTPRequestMethods.POST) || method.equals(HTTPRequestMethods.PUT)) && (bodyContentExclusive.bodySize != null || bodyContentExclusive.bodyFile != null) && verbose != null) {
            System.out.println("Selected request method cannot have a file body, aborting..");
            return 1;
        }

        HttpStressTestConfiguration configuration = new HttpStressTestConfiguration(
                host, port, method, headers, bodyContentExclusive.bodyFile,
                bodyContentExclusive.bodySize, expectStatus, frequency, duration,
                parallel, verbose != null
        );
    ...
    private static class BodyContentExclusive {
